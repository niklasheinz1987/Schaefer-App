...
const TierBearbeiten = () => {
    ...
    useEffect(() => {
        if (animals.length > 0) {
            ...
            if (animalToEdit) {
                setFormData({
                    ohrmarke: animalToEdit.ohrmarke || '',
                    name: animalToEdit.name || '',
                    art: animalToEdit.art || 'Schaf',
                    geschlecht: animalToEdit.geschlecht || 'Weiblich',
                    rasse: animalToEdit.rasse || '',
                    geburtsdatum: animalToEdit.geburtsdatum || '',
                    status: animalToEdit.status || 'Aktiv',
                    bemerkungen: animalToEdit.bemerkungen || ''
                });
            } else {
    ...
    if (loading) {
        return <div style={{ textAlign: 'center', padding: '2rem' }}>Lade Tierdaten...</div>;
    }
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <h1 style={{ marginBottom: '1.5rem' }}>Tier bearbeiten</h1>
